...
pre. echo "deb http://ppa.launchpad.net/pms-client-team/ppa/ubuntu hardy main" | sudo tee -a /etc/apt/sources.list && sudo apt-key adv --keyserver keyserver.ubuntu.com --recv-keys A2996F07 && sudo apt-get update && sudo apt-get install pms-client
